 ...
 */
@XmlRootElement
public class Spiel77Field extends Field {

    private static final long serialVersionUID = -4722276634647804744L;
    ...
    public boolean isValidFilled() {
        if ((getSelectedNumbers() != null) && (getSelectedNumbers().size() == Spiel77Lottery.SELECTABLE_NUMBERS)) {
            for (Integer selectedNumber : getSelectedNumbers()) {
                if ((selectedNumber == null) || (selectedNumber < 0) || (selectedNumber > Spiel77Lottery.HIGHEST_SELECTABLE_NUMBER)) {
                    return false;
                }
            }
