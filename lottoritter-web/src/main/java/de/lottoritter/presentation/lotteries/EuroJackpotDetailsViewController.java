...
@Named
@ViewScoped
public class EuroJackpotDetailsViewController extends AbstractViewController implements Serializable {
    ...
    public EuroJackpotDetailsViewController() {
    }
    ...
    public String getDrawingDays(MainTicket ticket) {
        ...
        if (type != null) {
            if (type.equals(DrawingType.EUROJACKPOTFR)) {
                return resourceBundleRepository.getLocalized(DrawingType.EUROJACKPOTFR, Locale.GERMAN);
            }
        }
        return null;
    }
